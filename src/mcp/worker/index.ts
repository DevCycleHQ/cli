...
import { MCPToolRegistry, registerAllTools } from '../tools'
...
> {
    ...
    // @ts-ignore - Type compatibility issue with MCP SDK versions
    ...
    private getUserId(): string {
        return this.props.claims?.sub || this.props.claims?.email || 'unknown'
    }
...
function createWorker() {
    ...
    return new OAuthProvider({
        ...
        // @ts-expect-error - Type compatibility with OAuth provider and MCP agent
