...
export const selfTargetingToolDefinitions: Tool[] = [
    ...
    },
    {
        ...
        description: 'Update DevCycle identity for self-targeting',
        inputSchema: {
            type: 'object',
            properties: {
                dvc_user_id: { type: 'string', description: 'DevCycle User ID' },
            },
    ...
    },
    {
        ...
        description: 'List all self-targeting overrides',
        inputSchema: {
            type: 'object',
            properties: {},
        },
    },
    {
        ...
        inputSchema: {
            ...
            properties: {
                ...
                variation_key: { type: 'string', description: 'Variation key' },
            },
    ...
    },
    {
        ...
        description: 'Clear self-targeting overrides for a feature/environment',
        inputSchema: {
            type: 'object',
            properties: {
                feature_key: { type: 'string', description: 'Feature key' },
    ...
    },
    {
        ...
        description: 'Clear all self-targeting overrides',
        inputSchema: {
            type: 'object',
            properties: {},
        },
...
export const selfTargetingToolHandlers: Record<string, ToolHandler> = {
    get_self_targeting_identity: async (args: unknown, apiClient: DevCycleApiClient) => {
    ...
    update_self_targeting_identity: async (args: unknown, apiClient: DevCycleApiClient) => {
    ...
    list_self_targeting_overrides: async (args: unknown, apiClient: DevCycleApiClient) => {
        return await apiClient.executeWithLogging(
    ...
    set_self_targeting_override: async (args: unknown, apiClient: DevCycleApiClient) => {
        const validatedArgs = SetSelfTargetingOverrideArgsSchema.parse(args)
        return await apiClient.executeWithLogging(
            'setSelfTargetingOverride',
            validatedArgs,
            async (authToken, projectKey) => {
                return await updateOverride(authToken, projectKey, validatedArgs.feature_key, {
    ...
    clear_feature_self_targeting_overrides: async (args: unknown, apiClient: DevCycleApiClient) => {
    ...
    clear_all_self_targeting_overrides: async (args: unknown, apiClient: DevCycleApiClient) => {
        return await apiClient.executeWithLogging(
