...
describe('variations create', () => {
    ...
    dvcTest()
        ...
        .it(
            'creates a variation and returns the full feature in headless mode',
            (ctx) => {
    ...
    dvcTest()
        ...
        .it(
            'creates a variation and returns the full feature in interactive mode',
            (ctx) => {
                expect(ctx.stdout).toMatchSnapshot()
            },
        )
    ...
    dvcTest()
        ...
        .nock(BASE_URL, (api) =>
            api
                .get(
                    `/v1/projects/${projectKey}/variables?feature=${mockFeature._id}`,
                )
        ...
        .it('prompts for missing fields in interactive mode', (ctx) => {
            expect(ctx.stdout).toMatchSnapshot()
        })
    dvcTest()
        .do(async () => {
        ...
        .catch((err) => null)
        .it('errors when missing required flags in headless mode', (ctx) => {
