...
import { FileMatch, ParseOptions, VariableMatch } from '../parsers/types'
...
export const parseFiles = (files: File[], options: ParseOptions = {}): Record<string, FileMatch[]> => {
    const resultsByLanguage: Record<string, FileMatch[]> = {}
