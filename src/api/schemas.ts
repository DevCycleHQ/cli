...
>;
export const UserPlatformVersionFilterSchema =
  schemas.UserPlatformVersionFilter;
...
export type UpdateOverrideParams = z.infer<
  typeof schemas.UpdateUserOverrideDto
>;
