...
USAGE
  $ dvc usages [--config-path <value>] [--auth-path <value>] [--repo-config-path <value>] [--client-id
    ...
    [--include <value>] [--exclude <value>] [--client-name <value>] [--match-pattern <value>] [--var-alias <value>]
    [--format console|json] [--show-regex]
...
_See code: [dist/commands/usages/index.ts](https://github.com/DevCycleHQ/cli/blob/v4.2.9/dist/commands/usages/index.ts)_
