...
_See code: [src/commands/variables/create.ts](https://github.com/DevCycleHQ/cli/blob/v5.14.15/src/commands/variables/create.ts)_
...
_See code: [src/commands/variables/get.ts](https://github.com/DevCycleHQ/cli/blob/v5.14.15/src/commands/variables/get.ts)_
...
_See code: [src/commands/variables/list.ts](https://github.com/DevCycleHQ/cli/blob/v5.14.15/src/commands/variables/list.ts)_
...
_See code: [src/commands/variables/update.ts](https://github.com/DevCycleHQ/cli/blob/v5.14.15/src/commands/variables/update.ts)_
