...
USAGE
  $ dvc diff [DIFF-PATTERN] [--config-path <value>] [--auth-path <value>] [--repo-config-path <value>]
    [--client-id <value>] [--client-secret <value>] [--project <value>] [--no-api] [--headless] [--caller
    github|bitbucket|cli] [-f <value>] [--client-name <value>] [--match-pattern <value>] [--var-alias <value>] [--format
...
_See code: [dist/commands/diff/index.ts](https://github.com/DevCycleHQ/cli/blob/v4.2.9/dist/commands/diff/index.ts)_
