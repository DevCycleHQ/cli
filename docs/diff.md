...
USAGE
  $ dvc diff [DIFF-PATTERN] [--config-path <value>] [--auth-path <value>] [--repo-config-path <value>]
    ...
    [--exclude <value>] [-f <value>] [--client-name <value>] [--match-pattern <value>] [--var-alias <value>] [--format
    console|markdown|markdown-no-html] [--show-regex]
...
_See code: [dist/commands/diff/index.ts](https://github.com/DevCycleHQ/cli/blob/v5.11.1/dist/commands/diff/index.ts)_
